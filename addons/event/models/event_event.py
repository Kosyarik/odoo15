...
class EventEvent(models.Model):
    ...
    eligibility_second = fields.Text(string="The II sentence")
    # programme
    counterForProgramme = fields.Integer(string='counterForProgramme')
    imageForProgramme = fields.Char(string="Image for programme")
    visibleForProgramme = fields.Boolean(string="Visible for Programme", default=False)
    programme_text_1 = fields.Text(string='Programme Text 1')
    programme_text_2 = fields.Text(string='Programme Text 2')
    programme_text_3 = fields.Text(string='Programme Text 3')
    programme_text_4 = fields.Text(string='Programme Text 4')
    programme_text_5 = fields.Text(string='Programme Text 5')
    programme_text_6 = fields.Text(string='Programme Text 6')
    programme_text_7 = fields.Text(string='Programme Text 7')
    programme_text_8 = fields.Text(string='Programme Text 8')
    programme_text_9 = fields.Text(string='Programme Text 9')
    programme_text_10 = fields.Text(string='Programme Text 10')
